    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contents', models.TextField(null=True, verbose_name='본문')),
                ('post_start_day', models.DateField(verbose_name='노출 시작일')),
                ('post_end_day', models.DateField(verbose_name='노출 종료일')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
